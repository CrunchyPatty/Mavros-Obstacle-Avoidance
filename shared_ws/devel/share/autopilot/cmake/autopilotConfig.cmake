...
if("TRUE" STREQUAL "TRUE")
  set(autopilot_SOURCE_PREFIX /home/Queen/shared_ws/src/autopilot)
  set(autopilot_DEVEL_PREFIX /home/Queen/shared_ws/devel)
  ...
  set(autopilot_INSTALL_PREFIX /home/Queen/shared_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Queen <Queen@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'autopilot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/Queen/shared_ws/src/autopilot/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/Queen/shared_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(autopilot_EXPORTED_TARGETS ${${autopilot_dep}_EXPORTED_TARGETS})
endforeach()
